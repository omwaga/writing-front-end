        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md offset-md-2">
                    <button
                        class="bg-green-400 hover:bg-green-600 transition duration-200 w-full p-2 text-white rounded mb-10 rounded-2xl focus:outline-none shadow-lg hover:shadow-2xl font-bold"
                        wire:click="success">{{ __('Submit') }}</button>
                </div>
            </div>
        </div>
    </div>
