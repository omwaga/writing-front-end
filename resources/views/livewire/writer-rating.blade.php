        ...
        <div class="max-w-5xl mx-auto">
            <div class="flex flex-col items-center md:flex-row">
                ...
                <div class="w-full mt-16 md:mt-0">
                    <div class="relative z-10 h-auto p-4 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-lg px-7">
                        @auth
                                ...
                                <div class="box">
                                    <div class="flex items-start p-5">
                                        <div class="w-full flex flex-col lg:flex-row items-center">
                                            <div class="image-fit">
                                                <img alt="{{$writer->name}}" class="w-16 h-16 rounded-full overflow-hidden" src="{{asset('storage/'.$writer->profile_photo_path)}}" />
                                            </div>
                        ...
                        <form wire:submit.prevent="rate()">
                            <div class="block px-1 py-2 mx-auto">
                                <div class="flex space-x-1 py-3 rating">
                                    <label for="star1">
                            ...
                            <div class="block">
                                <button type="submit" class="px-3 py-2 font-medium text-white bg-blue-600 rounded-lg">Rate</button>
                                <!-- @auth
                                @if($currentId)
                                <button type="submit" class="px-3 py-2 mt-4 font-medium text-white bg-red-400 rounded-lg" wire:click.prevent="delete({{ $currentId }})" class="text-sm cursor-pointer">Delete</button>
                                @endif
                                @endauth -->
                            </div>
                        </form>
                        ...
                        <div>
                            <div class="mb-8 text-center text-gray-600">
                                You need to login in order to be able to rate the writer!
                            </div>
