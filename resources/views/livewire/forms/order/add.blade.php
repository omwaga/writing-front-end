                ...
                <div class="border-b-2 py-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div class="flex-1">
                            ...
                            <div x-show="step === 3">
                                <div class="text-lg font-bold text-gray-700 leading-tight">Upload Files & Pay</div>
                            </div>
                            <div x-show="step === 4">
                    ...
                    <form wire:submit.prevent="Order">
                        ...
                        <div x-show.transition.in="step === 1">
                            <div class="mb-5">
                                ...
                                <select id="type" name="type" required wire:model="type"
                                    ...
                                    <?php
                                    use Illuminate\Support\Facades\DB;$types = DB::table('settings_disciplines')
                                        ->orderBy('disciplines')
                                        ->get();
                                    ?>
                            ...
                            <div class="mb-5">
                                ...
                                <select id="service" name="service" wire:model="service"
                                    ...
                                    <option value="">--select--</option>
                                    <?php
                                    $services = DB::table('settings_services')
                                        ->orderBy('name')
                                        ->get();
                                    ?>
                            ...
                            <div class="mb-5">
                                <label for="deadline-time" class="font-bold mb-1 text-gray-700 block">Deadline</label>
                                <select wire:model="deadline" id="deadline-time"
                            ...
                            <div class="mb-5">
                                ...
                                <select name="level" id="level" aria-label="level" wire:model="level"
                                    ...
                                    <?php
                                    $levels = DB::table('settings_degrees')
                                        ->orderBy('name')
                                        ->get();
                                    ?>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        ...
                                        <?php
                                        $subjects = DB::table('settings_languages')
                                            ->orderBy('language')
                                            ->get();
                                        ?>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        ...
                                        <?php
                                        $styles = DB::table('settings_citations')
                                            ->orderBy('style')
                                            ->get();
                                        ?>
                        ...
                        <div x-show.transition.in="step === 3">
                            <div class="mb-5">
                                ...
                                <div class="mt-2 mb-4">
                                    Upload all necessary files below then click 'Pay with paypal' to complete your
                                    order.
                                </div>
                                ...
                                <div class="flex flex-row flex-wrap space-x-10">
                                    ...
                                    {{--                                        @if ($file)--}}
                                    {{--                                            <div class="mt-4">--}}
                                    {{--                                                <span class="text-sm text-gray-400">Photo Preview:</span>--}}
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="w-1/2 text-right">
                                    <button
                                        ...
                                        class="focus:outline-none py-2 flex space-x-3 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-blue-600 font-medium transition duration-200 font-bold"
                                    ><img src="{{ asset('images/icons/safari-pinned-tab.svg') }}"
                                          style="width: 20px; height: 20px" alt=""></ion-icon>Pay With Paypal
                                    </button>
